...
function AnimatedCard({ children }: { children: React.ReactNode }) {
  return (
    <div
      className="auth-form-enter aurora-border w-full max-w-sm rounded-3xl border border-border/60 bg-card/60 p-6 shadow-xl shadow-blue-500/5 backdrop-blur-sm sm:p-8"
    >
      {children}
    </div>
  );
