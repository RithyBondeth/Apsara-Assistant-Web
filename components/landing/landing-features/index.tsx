...
function FeatureCard({
  ...
  return (
    <div
      ref={tiltRef}
      className="group relative rounded-2xl border border-border/60 bg-card/50 backdrop-blur-sm p-5 sm:p-7 transition-[border-color,box-shadow] duration-300 hover:border-blue-400/40 hover:shadow-lg hover:shadow-blue-500/5 transform-3d"
    >
    ...
    >
      ...
      <div className="relative z-10 mx-auto max-w-6xl px-4 sm:px-6 md:px-8">
        ...
        <div
          ...
          className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8 perspective-distant"
        >
