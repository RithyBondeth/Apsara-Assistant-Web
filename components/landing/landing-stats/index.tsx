...
export default function LandingStats() {
  ...
  return (
    <section
      ref={sectionRef}
      className="relative border-y border-border/60 bg-card/30 py-10 sm:py-14"
    >
      ...
      <div className="stagger-list relative z-10 mx-auto flex w-fit max-w-4xl flex-col gap-8 px-4 sm:grid sm:w-auto sm:grid-cols-3 sm:gap-6 sm:px-6">
        {STATS.map((stat) => (
          <div
            key={stat.label}
            className="flex w-full items-center gap-4 sm:w-auto sm:flex-col sm:items-center sm:gap-2 sm:text-center"
          >
            ...
            <div className="flex flex-col sm:items-center">
              <span
                ...
                className="text-3xl sm:text-4xl font-bold bg-linear-to-r from-blue-600 to-blue-500 bg-clip-text text-transparent"
              >
                {stat.value}
              </span>
